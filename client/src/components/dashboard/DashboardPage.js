...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // pass in access token for getReports
  ...
  }, [getAccessTokenSilently]); // pass in as dependancy to make sure it runs when getAccessTokenSilently changes
